...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "81 Interview Preparation Topics | Guru Sishya",
    description:
      "Explore 81 topics with full lessons, quizzes, and cheat sheets. System design, DSA, and core CS for FAANG interviews.",
