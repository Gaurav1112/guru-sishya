...
export const metadata: Metadata = {
  ...
  description:
    "Review interview concepts with SM-2 spaced repetition flashcards. Retain knowledge longer with scientifically-proven review intervals across all 138 topics.",
  openGraph: {
    title: "Flashcard Review - Spaced Repetition | Guru Sishya",
    description:
