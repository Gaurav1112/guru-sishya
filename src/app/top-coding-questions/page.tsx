...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Top 100 Coding Interview Questions by Company (2026) | Guru Sishya",
    description:
      "100 most-asked coding questions at Google, Amazon, Meta, Microsoft, Apple. Free practice with lessons and quizzes.",
    images: [`${BASE}/api/og`],
  },
};
...
export default function TopCodingQuestionsPage() {
  ...
  const itemListSchema = {
    ...
    "@type": "ItemList",
    name: "Top 100 Coding Interview Questions by Company (2026)",
    description:
      "The 100 most frequently asked coding interview questions organized by company.",
    numberOfItems: CODING_QUESTIONS.length,
    itemListElement: CODING_QUESTIONS.slice(0, 20).map((q, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: q.question,
      url: findSlug(q.learnTopic)
        ? `${BASE}/learn/${findSlug(q.learnTopic)}`
        : `${BASE}/top-coding-questions`,
    })),
  };
