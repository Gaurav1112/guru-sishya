...
const FAQS: FAQItem[] = [
  {
    ...
    a: "Guru Sishya provides 80 comprehensive topics, 1,715 curated interview questions with detailed answers, AI mock interviews, STAR behavioral prep for 6 FAANG companies, adaptive quizzes, spaced repetition flashcards, and a code playground — all in one platform. Pro members get unlimited access to all features.",
  },
  {
  ...
  },
  {
    ...
    a: "81 topics across multiple domains: System Design (30+ topics), Data Structures & Algorithms, Java Core, Spring Boot, JavaScript/TypeScript, React/Next.js, Node.js, HTML/CSS, RDBMS/SQL, NoSQL, Kafka, AWS, Kubernetes/Docker, Design Patterns, and more. New topics are added regularly.",
  },
  {
    q: "How is this different from LeetCode, AlgoExpert, or NeetCode?",
    a: "Guru Sishya combines comprehensive teaching content with 1,730 questions (with full answers, not just hints), 58 STAR behavioral answers, AI mock interviews, company-specific prep for FAANG, spaced repetition flashcards, offline access, and adaptive quizzes — all at ₹149/month. Competitors charge ₹991-₹2,917/month and still lack behavioral prep and offline support.",
  },
  {
